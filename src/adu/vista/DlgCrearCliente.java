...
public class DlgCrearCliente extends javax.swing.JDialog {
    ...
    /**
     * Creates new form DlgCrearCliente
     */
    ...
    private void initComponents() {
        ...
        txt_fijo = new javax.swing.JFormattedTextField();
        txt_ci = new javax.swing.JFormattedTextField();
        ...
        txt_celular.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));

        txt_fijo.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));

        txt_ci.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_fijo, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                            .addComponent(txt_ci)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
...
//        doClose(RET_OK);
    ...
    private javax.swing.JFormattedTextField txt_ci;
    private javax.swing.JTextField txt_direccion;
    private javax.swing.JFormattedTextField txt_fijo;
    ...
    private void crearCliente() {
        try {
            ...
            int fijo = Integer.parseInt(txt_fijo.getText());
            int celular = Integer.parseInt(txt_celular.getText());
            Cliente cliente = new Cliente(ci, nombre, paterno, materno, direccion, fijo, celular);
            cliente.save();
            doClose(RET_OK);
        } catch (SQLException ex) {
            Logger.getLogger(DlgCrearCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
